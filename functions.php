    ...
    if($user){
        ...
        $out .= '<div class="fusion-layout-column fusion_builder_column fusion_builder_column_1_1 fusion-builder-column-2 fusion-one-full fusion-column-first fusion-column-last 1_1" style="margin-top:0px;margin-bottom:20px;">';
            ...
            $out .= '<div class="fusion-builder-row fusion-row">';
                ...
                $out .= '<input type="text" name="Pedido[latitud]" id="lat-map" value="0">';
                $out .= '<input type="text" name="Pedido[longitud]" id="lng-map">';
                $out .= '<input type="text" name="Pedido[direccion_completa]" id="place-map">';
                $out .= '<input type="text" name="Pedido[codigo_postal]" id="postal-map">';
                $out .= '</div>';
            $out .= '</div>';
