...
function api_youneed_contratar(){
    ...
    wp_register_style('bootstrap-icons-v3', 'https://youneed.com.ec/wp-content/themes/Avada-Child-Theme/lib/glyphicons-only-bootstrap/css/bootstrap.css');
    wp_enqueue_style( 'bootstrap-icons-v3' );
