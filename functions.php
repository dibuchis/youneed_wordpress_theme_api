    ...
    if($user){
        ...
        $out .= '<form id="contratar-asociado" method="post" action="https://youneed.com.ec/contratar/" >';
            ...
            $out .= '<table class="table-2">';
                $out .= '<tr>';
                $out .= '<td><div class="container"><div class="col-sm-6"><div class="form-group"><div class="input-group date" id="datetimepicker12"><input type="text" class="form-control" /><span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span></div></div></div>';
